        ...
        <div className="flex items-center gap-8">
          ...
          >
            ...
            {cartItems && cartItems.length > 0 && (
              <div className=" absolute -top-3.5 -right-4 w-5 h-5 rounded-full bg-cartNumBg flex items-center justify-center">
          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "karan0362.be20@chitkara.edu.in" && (
                  <Link to={"/createItem"}>
                    <p
